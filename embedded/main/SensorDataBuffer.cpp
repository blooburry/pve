...
const void SensorDataBuffer::stuurData() {
  for(size_t i = imuNieuweDataIndex; i < imuSensorData.elements(); ++i) { // iterereer door de vector, beginnend bij de eerste index nog niet gestuurd is
    char report[120];
  ...
  imuNieuweDataIndex = imuSensorData.elements(); // de cursor wordt verplaatst naar de het einde van de vector, aangezien alles nu gestuurd is
